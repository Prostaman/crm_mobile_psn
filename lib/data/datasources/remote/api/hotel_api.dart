...
import 'package:psn.hotels.hub/data/models/response_models/locations_response.dart';

class HotelApi extends BaseApi {
  HotelApi() : super();

  // Получим ВСЕ отели
  Future<HotelsResponse?> getAll(
      String? lastModifyDate, bool developerMode) async {
    try {
      String query = "gethotels";
      // добавляем дату последней модификации если надо
      // Если пустая - берем первое января 2020
      query += lastModifyDate != null
          ? "?lastModifyDate=$lastModifyDate"
          : "?lastModifyDate=01.01.2000";
